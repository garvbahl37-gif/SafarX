    ...
    <div className="min-h-screen bg-[#070a13] text-slate-100 pt-20 pb-24 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-6xl mx-auto relative z-10 space-y-8">
        ...
        <motion.div key={activeTab} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.25 }}>
          {activeTab === 'reel' && (
            <ReelPlayer photos={journey.photos || []} tripTitle={journey.tripTitle} travelerName={journey.travelerName}
              onOpenShareModal={() => setIsShareModalOpen(true)} />
          )}
          {activeTab === 'journal' && (
            <StoryTimeline photos={journey.photos || []} tripTitle={journey.tripTitle} summary={journey.summary} travelerName={journey.travelerName} />
          )}
