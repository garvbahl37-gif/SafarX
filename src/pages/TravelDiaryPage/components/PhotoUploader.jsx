...
export const PhotoUploader = ({
 ...
 toast.success(`Added ${newPhotoObjects.length} photos! Tap "AI Storyteller" to craft cinematic captions.`);
 };
 ...
 toast.success('Applied instant AI story & captions from smart cache!');
 return;
 }
