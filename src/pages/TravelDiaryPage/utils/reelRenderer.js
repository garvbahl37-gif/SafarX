 ...
 * 4. 🕊️ Slow Luxury Gallery (Minimalist Vogue framing, silky continuous morph, golden haze)
 */
...
export const EDIT_PRESETS = [
  ...
  { id: 'wanderlust', label: 'Luxury Gallery', emoji: '🕊️', desc: 'Minimalist editorial framing & silky slow-motion drift' },
];
...
export class ReelRenderer {
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  // 4. 🕊️ SLOW LUXURY GALLERY (Minimalist Vogue Framing, Silky Morph, Gold Haze)
  // ─────────────────────────────────────────────────────────────────────────────
  ...
  drawFilmBurn(progress) {
    ...
    if (burnAlpha > 0.01) {
      ...
      const burnGrad = this.ctx.createRadialGradient(
        this.width * 0.9, this.height * 0.2, 20,
