...
const Header = () => {
 ...
 >
 {currentPage === link.id && (<motion.span
 ...
 {isSignedIn && clerkUser ? (<div className="px-2">
 ...
 {PRIMARY_LINKS.map((link, idx) => (<motion.button
 key={link.id}
 ...
 {MORE_LINKS.map((item, idx) => (<motion.button
 key={item.id}
 ...
 {!isSignedIn && isLoaded && (<div className="flex gap-3 mt-8">
