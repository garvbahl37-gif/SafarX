...
const GeminiItineraryDisplay = ({ itinerary, formData, onRegenerate, onTweak }) => {
  ...
  const chip = (Icon, children, gold = false) => (
    <span
  ...
  return (
    <div className="mt-8">
      ...
      <div className="flex flex-wrap gap-2.5 justify-center mb-8">
        ...
        {onTweak && (
          <button type="button" onClick={onTweak} className="btn-ghost">
      ...
      <div ref={itineraryRef} className="p-4 sm:p-5 bg-ink-950 rounded-3xl">
        ...
        >
          ...
          <div className="relative z-10 p-6 sm:p-9 md:p-11">
            ...
            {recommendationReason && (
              <div className="mt-7 flex items-start gap-3 rounded-xl border border-white/[0.07] bg-white/[0.04] p-4 max-w-3xl">
            ...
            {tripSummary && (
              <p className="mt-7 pt-7 border-t border-white/[0.07] text-ivory-muted leading-relaxed max-w-3xl">
                {tripSummary}
              </p>
            )}
          </div>
        ...
        {/* Day-by-day */}
        {days.length > 0 && (
          <section aria-label="Day by day plan" className="mb-8">
