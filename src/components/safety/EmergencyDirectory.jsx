...
export default function EmergencyDirectory() {
 ...
 const filteredEmbassies = EMBASSY_DIRECTORY.filter((emb) =>
 ...
 {/* ======================================================== */}
 {activeSection === "states" && (<div className="space-y-4">
 ...
 {data.stateNotes && (<p className="text-[11px] text-ivory-faint pt-2 border-t border-white/5 line-clamp-2">
 {data.stateNotes}
 </p>
 )}
 </div>
 ...
 {/* ======================================================== */}
 {activeSection === "national" && (<div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
 {NATIONAL_EMERGENCY_NUMBERS.map((item) => (<div
 key={item.id}
 ...
 {/* ======================================================== */}
 {activeSection === "embassies" && (<div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
 {filteredEmbassies.map((emb) => (<div
 key={emb.country}
