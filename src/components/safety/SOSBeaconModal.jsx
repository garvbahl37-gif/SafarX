    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 sm:p-6 pt-16 sm:pt-20 pb-12 overflow-y-auto">
        ...
        >
          ...
          {isArmed && (
            <div className="bg-saffron/15 border-b border-saffron/30 px-5 py-3 flex items-center justify-between">
            ...
            <div className="bg-ink-950/80 border border-white/10 rounded-2xl p-4 flex flex-wrap items-center justify-between gap-3 text-xs">
              <div className="flex items-start gap-2.5 flex-1 min-w-[240px]">
                ...
                <div>
                  ...
                  {locationLoading ? (
                    <p className="text-ivory-faint animate-pulse">Acquiring high accuracy GPS lock…</p>
                  ) : (
                    <>
              ...
              <div className="flex items-center gap-3">
                {batteryLevel !== null && (
                  <div className="flex items-center gap-1 text-ivory-muted bg-white/5 px-2.5 py-1.5 rounded-lg border border-white/5">
              ...
              <div className="space-y-4">
                ...
                <div>
                    ...
                    {contacts
                      ...
                      .map((contact) => (
                        ...
                        >
                          ...
                          {selectedContactPhone === contact.phone && (
                            <Check className="w-4 h-4 text-horizon-bright shrink-0" />
                          )}
                        </button>
                      ))}
                  ...
                  <p className="text-[11px] text-ivory-muted mt-2">
                    {selectedContactPhone ? (
                      <span className="text-horizon-bright font-medium">
