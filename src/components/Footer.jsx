...
const LinkColumn = ({ title, links, onPageChange }) => (<div>
...
const Footer = ({ onPageChange }) => {
 return (<footer className="relative bg-ink-900 border-t border-white/[0.06] overflow-hidden">
