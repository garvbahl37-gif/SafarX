...
-- Covers are 1600x900 at q=85. The cards render ~380px wide, so w=800 was
-- already marginal on a retina screen and the detail hero is full-bleed;
-- the fixed 16:9 also stops the portrait Varanasi shot cropping badly.
